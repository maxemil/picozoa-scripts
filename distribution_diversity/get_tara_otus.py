...
#         Tara_OTUs.fasta --db Picozoa_18S_all.fasta --id 0.97 \
#         --blast6out TARA_Picozoa.out
# """
...
m.scatter(-110.7122, 26.7313, latlon=True, c='black', alpha=1, s=40)
m.scatter(19.8633, 58.4880, latlon=True, c='black', alpha=1, s=40)
...
plt.scatter([], [], c='black', alpha=1, s=40, label='SAG sampling')
